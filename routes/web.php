...
Route::get('/insert-video', [App\Http\Controllers\Video\VideoController::class, 'insertURL'])->name('video.insert');
Route::post('/insert-video', [App\Http\Controllers\Video\VideoController::class, 'storeVideo'])->name('video.store');
